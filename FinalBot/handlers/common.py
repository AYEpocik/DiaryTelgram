...
from data.consts_and_vars import DB_PATH  # Импортируем константы и переменные
...
async def start_message(message: types.Message, state: FSMContext):
    ...
    await message.answer("Привет! Я бот, который может помочь тебе с разными вещами. Выбери одну из кнопок ниже.",
